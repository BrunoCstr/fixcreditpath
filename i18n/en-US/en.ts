...
export const en = {
  ...
  hero: {
    ...
    subtitle:
      "We help everyday people correct credit errors, strengthen their credit profile, and move forward — with expert guidance and full transparency every step of the way.",
    cta1: "Start My Credit Repair",
    cta2: "Contact Us",
    disclaimer:
      "No gimmicks. No empty promises. Just a clear, professional process — led by real experts and supported by smart technology. Everything we do is based on your rights under the Fair Credit Reporting Act (FCRA) and the industry standards of Metro 2 Compliance.",
  },
  stats: {
    ...
    barriers: [
      {
        ...
        stat: "Varies by lender",
        statDescription: "Lenders typically review credit history",
        consequence: "May be denied or face high interest rates",
        urgency: "Important consideration",
        solution: "Strong credit improves chances of home loan approval",
      },
      {
        icon: "🚗",
        title: "Auto Loans",
        ...
        consequence: "Tougher terms, fewer lender options",
        urgency: "Financial planning consideration",
        solution: "Better scores often mean better rates",
      },
      {
        icon: "💳",
        ...
        consequence: "Limited options with high fees",
        urgency: "Housing consideration",
        solution: "Higher credit opens doors to better rewards cards",
      },
      {
        icon: "🏢",
